/**
 * Docinhos 2026 — montador de cento (até 4 sabores por categoria de preço).
...
(function () {
    ...
    function updateResumo() {
        ...
        if (!box) return;
        if (!cat) {
            box.innerHTML = '<p class="dh-resumo-placeholder">Escolha uma categoria e até quatro sabores.</p>';
